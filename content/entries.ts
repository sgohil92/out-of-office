...
export const ENTRIES: Entry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "And it doesn't have to be somewhere far away or exotic. The cafés I cycle between, Saint Frank, Spro, and Blue Bottle, are all within a five-minute walk, and they feel just as sacred. My order is an oat latte or an oat cappuccino, depending on the day. I know the baristas and they know me, to the point where every interaction flows seamlessly from the last one. Close to home, it's a mix of flavor, pleasure, familiarity, and groundedness, and these days very little about utility.",
