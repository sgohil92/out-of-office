...
export const ENTRIES: Entry[] = [
  ...
  },
  {
    ...
    dek: "Still brewing…",
    body: [
      "When I tell people I've quit my job and have no intention of starting anything new soon, I'm met with bewilderment. The immediate next question is, “Well, what do you do all day if you're not working?” I know it comes from genuine curiosity, but it's a bit disheartening that so many people, at least in SF, can't see past their careers.",
