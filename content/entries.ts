...
export const ENTRIES: Entry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The power of a ritual is that it's different from a habit or doing something for the sake of the function. It's a bit more sacred, almost spiritual, and always intentional. It becomes so essential and ingrained in your life that taking it away feels deeply unsettling and borderline disturbing.",
