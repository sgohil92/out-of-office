...
export const ABOUT: Entry = {
  ...
  body: [
    ...
    "Y'all know I quit my job end of June-ish and turned down another one in July because something just felt misaligned. I went from degree to degree, climbed the ladder, did everything “right”… and one day I didn't recognize myself, and questioned whether this was all there was… or where I was going.",
    ...
    "Since I don't have any social media, this is a more personal digital journal of sorts, a way to capture the transition in real time. Honestly, I have no idea what's next. But I have full conviction I made the right choice, and that whatever comes will be beautiful, and that you guys will help me shape it.",
