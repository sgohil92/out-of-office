...
export const ABOUT: Entry = {
  ...
  body: [
    ...
    "Y'all know I quit my job and turned down another one because something just felt misaligned. I went from degree to degree, climbed the ladder, did everything “right”… and one day I didn't recognize myself.",
    ...
    "This is a digital journal of sorts, a way to capture the transition in real time. Honestly, I have no idea what's next. But I have full conviction I made the right choice, and that whatever comes will be beautiful.",
